...
class DownloadTask extends DefaultTask {
    ...
    static final String down_url_win = "https://down.360safe.com/360Jiagu/360jiagubao_windows_64.zip"
...
//    private def walle_cli_url = "https://github.com/Meituan-Dianping/walle/releases/download/v1.1.6/walle-cli-all.jar"
    ...
    private static def downLoadFile(String downUrl, File saveFile) {
